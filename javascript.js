...
import { beautyProductData } from "./Data/beautyProduct.js"
...
// // ----------beautyProductData-----
let bestofBeauty_product_itemEl = document.querySelector(".bestofBeauty_product_item")
var bestofBeautyProduct_html = ""

console.log(beautyProductData)
beautyProductData.forEach(el => {

    /* class move div to a tag */  //change done
    
    bestofBeautyProduct_html += `
    <div class="bestofBeauty_product_item">
    <a href="${el.link}" class="BestofBeauty_item">   

    <div class="bestOfBeauty_image_Product">
        <img
            src=" ${el.img}" />
    </div>
    <br>
    <div class="bestofBeautymoreOption">
        <p class="bestofBeautyProduct_name">${el.productName}</p>
        <p class="bestofBeauty_discount">${el.discount}</p>
        <p class="bestofBeauty_brand">${el.brand}</p>
    </div>
    </a>
...
bestofBeauty_product_itemEl.innerHTML = bestofBeautyProduct_html
